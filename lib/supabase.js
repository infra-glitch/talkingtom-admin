// This file is deprecated - use createClient from @/lib/supabase/server instead
// Keeping for backward compatibility but all new code should use server client
...
// Note: This client doesn't have auth context for RLS
